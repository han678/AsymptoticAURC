...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        ...
        for batch_size in batch_size_list:
            ...
            loader = prepare_dataset(args.dataset, batch_size=batch_size, load_train=False, shuffle=False, num_workers=num_workers, data_dir=args.data_dir) 
        ...
        results = {}
        batch_size = 128
        loader = prepare_dataset(args.dataset, batch_size=batch_size, load_train=False, num_workers=4, data_dir=args.data_dir, shuffle=False) 
